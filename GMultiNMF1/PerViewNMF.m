function [U_final, V_final, nIter_final, elapse_final, bSuccess, objhistory_final] = PerViewNMF(X, k, Vo,W, options, U, V,K_complement,bro,nu1,nu2)
...
while tryNo < nRepeat   
    ...
    while(maxErr > differror)
        ...
        XU = XU + alpha * Vo;
        VUU = VUU + alpha * V+bro*K*V;
        
        V = V.*(XU./(max(VUU,1.00e-10)));
